...
if ( ! class_exists( 'EDD_Jilt_API_Exception' ) ) :

	/**
	 * Jilt for EDD exception - generic API Exception
	 *
	 * @since 1.1.0
	 */
	class EDD_Jilt_API_Exception extends Exception { }
